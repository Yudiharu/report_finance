...
@section('title', 'Laporan Cash Bank')
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Laporan <b>Cash Bank</b></h4>
                </div>
                @include('errors.validation')
                {!! Form::open(['route' => ['laporancashbank.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            {{ Form::label('jenis', 'Cash Bank :') }}              
                                            {{Form::select('cashbank', $Cashbank->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'jenis1','required'=>'required'])}}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'{!! route('laporancashbank.export') !!}',
                    type:'GET',
                    data:formData,
